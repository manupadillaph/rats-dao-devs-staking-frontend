...
export default function UsersModalBtn({
    ...
    const [eUTxOs_UserDatum_Selected, setEUTxOs_UserDatum_Selected] = useState<
        EUTxO[]
    >([])
    ...
    useEffect(() => {
        if (isPoolDataLoaded) {
            ...
            eUTxOs_UserDatum_Selected.forEach((eUTxO) => {
                if (
                    eUTxOs_With_UserDatum.some(
                        (eUTxO_UserDatum) =>
                            eUTxO_UserDatum.uTxO.txHash === eUTxO.uTxO.txHash &&
                            eUTxO_UserDatum.uTxO.outputIndex ===
                                eUTxO.uTxO.outputIndex
                    )
                ) {
    ...
    async function downloadCVS() {
        let csvContent =
            ...
            'Deposit Date,Tx Hash,User Pkh,Invest Amount (' +
            poolInfo.staking_UI +
            '),Rewards Harvested (' +
            poolInfo.harvest_UI +
            '),Rewards Not Claimed (' +
            ...
            eUTxOs_With_UserDatum
                .map(
                    (e) =>
                        new Date(
                            parseInt(e.datum.udCreatedAt.toString())
                        ...
                        ',' +
                        Number(
                            typeof eUTxO_With_PoolDatum == 'object'
                                ? Number(
                                      getRewardsToPay_In_EUTxO_With_UserDatum(
                                          poolInfo,
                                          eUTxO_With_PoolDatum,
                                          e
                                      )
    ...
    return (
        <div className="modal__action_separator">
            {swShow ? (
                <>
                    {swPaddintTop === true || swPaddintTop === undefined ? (
                        <div>
                            <br></br>
                        </div>
                    ) : null}
                    {(swEnabledBtnOpenModal && isWorkingFromParent === '') ||
                    isWorkingFromParent === actionNameWithIdx ? (
                        // {swEnabledBtnOpenModal && (isWorkingFromParent === actionNameWithIdx || isWorkingFromParent === "") ?
                        <label
                            htmlFor={`${actionNameWithIdx}-modal-toggle`}
                    ...
                    <div className="modal__content_item">
                        <h3>List of UTxOs With Deposits</h3>
                        {
                            ...
                            >
                                <table>
                                    ...
                                    <tbody>
                                        {eUTxOs_With_UserDatum.map((eUTxO) => (
                                            <tr
                                                key={
                                                    eUTxO.uTxO.txHash +
                                                    '#' +
                                            ...
                                            >
                                                <td>
                                                    <input
                                                        ...
                                                        checked={eUTxOs_UserDatum_Selected.some(
                                                            (eUTxO_UserDatum) =>
                                                                eUTxO_UserDatum
                                                                    .uTxO
                                                                    .txHash ===
                                                        ...
                                                        onChange={(e) => {
                                                            if (
                                                                ...
                                                                setEUTxOs_UserDatum_Selected(
                                                                    eUTxOs_UserDatum_Selected.concat(
                                                                        eUTxO
                                                                    )
                                                                )
                                                            } else {
                                                                setEUTxOs_UserDatum_Selected(
                                                                    eUTxOs_UserDatum_Selected.filter(
                                                                        (
                                                                            eUTxO_UserDatum
                                                                        ) =>
                                                                            !(
                                                ...
                                                <td>
                                                    ...
                                                    <a
                                                        target={'_blank'}
                                                        href={`${process.env.NEXT_PUBLIC_BLOCKCHAIN_EXPLORER_URL}tx/${eUTxO.uTxO.txHash}`}
                                                        className="btn__ghost icon"
                                                        style={{
                                                            cursor: 'pointer',
                                                        }}
                                                ...
                                                <td>
                                                    {new Date(
                                                        parseInt(
                                                            eUTxO.datum.udCreatedAt.toString()
                                                        )
                                                    ).toLocaleString('en-US')}
                                                </td>
                                                <td>
                                                    {formatHash(
                                                        eUTxO.datum.udUser.toString()
                                                    )}
                                                </td>
                                                <td>
                                                    {formatAmount(
                                                        Number(
                                                            eUTxO.datum.udInvest
                                                        ),
                                                        poolInfo.staking_Decimals,
                                                        poolInfo.staking_UI
                                                    )}
                                                ...
                                                <td>
                                                    {eUTxO.datum.udLastClaimAt
                                                        .val == undefined
                                                        ? ''
                                                        : new Date(
                                                              parseInt(
                                                                  eUTxO.datum.udLastClaimAt.val.toString()
                                                              )
                                                          ).toLocaleString(
                                                              'en-US'
                                                          )}
                        ...
                        <div className="modal__content_btns">
                            <ActionModalBtn
                                ...
                                actionName="Send Back Deposit"
                                actionIdx={poolInfo.name + '-UserModal'}
                                messageFromParent={actionMessage}
                                hashFromParent={actionHash}
                                isWorking={isWorking}
                                description={
                                    '<li className="info">Return the Deposit to the chosen User</li>\
                                ...
                                swEnabledBtnOpenModal={
                                    ...
                                    isPoolDataLoaded &&
                                    eUTxOs_UserDatum_Selected.length == 1
                                }
                                swEnabledBtnAction={
                                    walletStore.connected &&
                                    isPoolDataLoaded &&
                            ...
                            <ActionModalBtn
                                ...
                                setIsWorking={handleSetIsWorking}
                                cancel={handleCancel}
                                actionName="Send Back Deposit Batch"
                                actionIdx={poolInfo.name + '-UserModal'}
                                messageFromParent={actionMessage}
                                hashFromParent={actionHash}
                                isWorking={isWorking}
                                description={
                                    '<li className="info">Return the Deposit to the Users</li>\
                                    ...
                                    onClick={(e) => {
                                        ...
                                        const checkbox: any =
                                            document.getElementById(
                                                `${actionNameWithIdx}-modal-toggle`
                                            )
