...
export default function StakingPool({
    ...
    useEffect(() => {
        ...
        if (walletStore.connected && !isWalletDataLoaded) {
            ...
            //------------------
            const assets = uTxOsAtWallet.reduce((acc: Assets, utxo) => {
            ...
            for (const [key, value] of Object.entries(assets)) {
                ...
                if (
                    CS_ === staking_CS &&
                    (staking_AC_isWithoutTokenName || TN_ === staking_TN)
                ) {
    ...
    const userHarvestAction = async (
        poolInfo?: StakingPoolDBInterface,
        eUTxOs_Selected?: EUTxO[],
        assets?: Assets
    ) => {
        return await newTransaction(
            'StakingPool - Harvest Pool',
            walletStore,
            poolInfo,
            userHarvest,
            isWorkingInABuffer.current,
    ...
    const userWithdrawAction = async (
        poolInfo?: StakingPoolDBInterface,
        eUTxOs_Selected?: EUTxO[],
        assets?: Assets
    ) => {
        return await newTransaction(
            'StakingPool - Withdraw Pool',
            walletStore,
            poolInfo,
            userWithdraw,
            isWorkingInABuffer.current,
    ...
    const userDepositBatchAction = async (
        poolInfo?: StakingPoolDBInterface,
        eUTxOs_Selected?: EUTxO[] | undefined,
        assets?: Assets
    ) => {
        ...
        try {
            ...
            for (let i = 1; i <= 50 && !isCancelling.current; i++) {
                ...
                const txHash = await userDepositAction(
                    poolInfo_updated,
                    eUTxOs_Selected,
                    assets
                )
    ...
    const splitUTxOsAction = async (
        ...
        return await newTransaction(
            'StakingPool - Split Wallet UTxOs',
            walletStore,
            poolInfo,
            splitUTxOs,
            isWorkingInABuffer.current,
        ...
        >
            <div className="pool__data">
                ...
                <div className="pool__action_cards ">
                            ...
                            {staking_AC_isWithoutTokenName ? (
                                <>
                                    <ActionWithInputMultiAssetsModalBtn
                                        ...
                                        description={
                                            !poolInfo.swIniciado
                                                ? '<p className="info" style="text-align: center;">The pool hasn\'t opened yet for deposits.</p>'
                                                : poolInfo.swClosed
                                                ? '<p className="info" style="text-align: center;" >This Pool is already closed. You can\'t Deposit anymore.</p>'
                                                : staking_AC_isAda
                                                ? '<li className="info">You are about to Deposit <b>' +
                                                  poolInfo.staking_UI +
                                                  '</b> to this Pool.</li>\
															<li className="info">In return, you will receive User Tokens (<b>' +
                                                  userDeposit_TN +
                                                  '</b>) that you must to keep safe.</li>\
															<li className="info">You can withdraw your <b>' +
                                                  poolInfo.staking_UI +
                                                  '</b> at any time in exchange for the given User Tokens.</li>'
                                                : '<li className="info">You are about to deposit <b>' +
                                                  poolInfo.staking_UI +
                                                  '</b> to this Pool.</li>\
															<li className="info">In return, you will receive User Tokens (<b>' +
                                                  ...
                                                  poolInfo.staking_UI +
                                                  '</b> at any time in exchange for the given User Tokens.</li>\
															<li className="info">Please note that, in addition to the Transactions Fees, a minimum of ADA is required to be sent along with your <b>' +
                                                  poolInfo.staking_UI +
                                                  '</b>.</li>\
                                        ...
                                        inputMax={walletStakingAmountUI}
                                        inputDecimals={
                                            poolInfo.staking_Decimals
                                        }
                            ...
                            {process.env.NODE_ENV === 'development' ? (
                                <ActionWithInputModalBtn
                                    ...
                                    description={
                                        poolInfo.swClosed
                                            ? '<p className="info" style="text-align: center;">This Pool is already closed. You can\'t Deposit anymore.</p>'
                                            : '<p className="info">Create multiple Transactions for new Deposits in one go, rather than manually entering each Transaction individually. However, you will still need to individually sign each Transaction.</p>'
                                    }
                                    poolInfo={poolInfo}
                                    swShowInput={true}
                                    inputUnitForLucid={poolInfo.staking_Lucid}
                                    inputUnitForShowing={poolInfo.staking_UI}
                                    inputMax={walletStakingAmountUI}
                                    inputDecimals={poolInfo.staking_Decimals}
                                    swEnabledBtnOpenModal={
                                        walletStore.connected &&
                                        isPoolDataLoaded &&
                                        isWalletDataLoaded
                        ...
                        <div className="pool__stat">
                            {poolInfo.swDelegate ? (
                                <ActionWithInputModalBtn
                                    ...
                                    isWorking={isWorking}
                                    description={
                                        '<p className="info" style="text-align: center;">When you delegate your wallet to the 1Mate pool, you are providing us with direct support! You can be confident that none of your ADA will be taken from your wallet and that you will retain complete control.</p>'
                                    }
                                    poolInfo={poolInfo}
                                    swEnabledBtnOpenModal={
                                        walletStore.connected &&
                            ...
                            <ActionWithInputModalBtn
                                ...
                                poolInfo={poolInfo}
                                swEnabledBtnOpenModal={
                                    walletStore.connected && isPoolDataLoaded
                                }
                                swEnabledBtnAction={
                                    walletStore.connected && isPoolDataLoaded
                                }
                    ...
                    {userStakedDatas.map((userStakedData) => (
                        <div
                            key={`${
                                userStakedData.eUTxO_With_UserDatum!.uTxO.txHash
                            }-${
                                userStakedData.eUTxO_With_UserDatum!.uTxO
                                    .outputIndex
                            }`}
                        >
                            <div className="pool__action_card ">
                                <div
                                    className="pool__stat"
                                ...
                                >
                                        ...
                                        {userStakedData.createdAtUI == 0 ? (
                                            ...
                                            <a
                                                ...
                                                href={`${
                                                    ...
                                                    userStakedData.eUTxO_With_UserDatum!
                                                        .uTxO.txHash
                                                }`}
                                                style={{
                                                    cursor: 'pointer',
                                    ...
                                    >
                                        ...
                                        {userStakedData.elapsedUI != 0 ? (
                                            <span
                                                dangerouslySetInnerHTML={{
                                                    __html: userStakedData.elapsedUI!,
                                                }}
                                            />
                                        ) : (
                                            <Skeleton
                                ...
                                <div className="pool__stat">
                                    <div>
                                        ...
                                        <h3 className="pool__stat-value">
                                            {userStakedData.rewardsToPayUI || (
                                                <Skeleton baseColor="#e2a7a7" />
                                            )}
                                        </h3>
                                        <div className="pool__stat-actions">
                                            <ActionWithInputModalBtn
                                                ...
                                                inputMax={userStakedData.rewardsToPay.toString()}
                                                inputDecimals={
                                    ...
                                    <div>
                                        ...
                                        <div className="pool__stat-actions">
                                            <ActionWithInputModalBtn
                                                ...
                                                isWorking={isWorking}
                                                description={
                                                    '<li className="info">Do you want to withdraw your Deposit?</li> \
													...
													<li className="info">If the Pool is still active ir order to continue you must provide the User Tokens (UD) you receive when you did the Deposit.</li>\
