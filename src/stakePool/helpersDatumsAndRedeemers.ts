...
export function mkUpdated_PoolDatum_With_NewFund(
    poolDatum: PoolDatum,
    master: Master,
    stakeCredential: Maybe<StakeCredentialPubKeyHash>,
    fundAmount: BIGINT,
    minAda: BIGINT
) {
    ...
    if (masterFunder_ToUpdate !== undefined) {
        masterFunderNew = new Master_Funder(master, masterFunder_ToUpdate.mfStakeCredential, fundAmount + masterFunder_ToUpdate.mfFundAmount, masterFunder_ToUpdate.mfClaimedFund, minAda + masterFunder_ToUpdate.mfMinAda);
    } else {
        masterFunderNew = new Master_Funder(master, stakeCredential, fundAmount, poolDatum_NotClaimedFund, minAda);
    }
...
export function mkUpdated_PoolDatum_With_NewFundAmountAndMerging(
    ...
    var masterFunderNew: Master_Funder
    if (masterFunder_ToUpdate !== undefined) {
        masterFunderNew = new Master_Funder(master, masterFunder_ToUpdate.mfStakeCredential, fundAmount + masterFunder_ToUpdate.mfFundAmount, masterFunder_ToUpdate.mfClaimedFund, masterFunder_ToUpdate.mfMinAda);
    } else {
        masterFunderNew = new Master_Funder(master, stakeCredential, fundAmount, poolDatum_NotClaimedFund, 0n);
    }
    masterFundersNew = [masterFunderNew].concat(masterFunder_others)
...
export function mkUpdated_PoolDatum_With_SplitFundAmount(
    ...
    var masterFunderNew: Master_Funder
    if (masterFunder_ToUpdate !== undefined) {
        masterFunderNew = new Master_Funder(master, masterFunder_ToUpdate.mfStakeCredential, masterFunder_ToUpdate.mfFundAmount, masterFunder_ToUpdate.mfClaimedFund, masterFunder_ToUpdate.mfMinAda + minAda);
    } else {
        masterFunderNew = new Master_Funder(master, stakeCredential, 0n, poolDatum_NotClaimedFund, minAda);
    }
    masterFundersNew = [masterFunderNew].concat(masterFunder_others)
...
export function mkUpdated_PoolDatum_With_SendBackFund(poolDatum: PoolDatum, master: Master) {
    ...
    var masterFunderNew: Master_Funder
    if (masterFunder_ToUpdate !== undefined) {
        masterFunderNew = new Master_Funder(master, masterFunder_ToUpdate.mfStakeCredential, masterFunder_ToUpdate.mfFundAmount, poolDatum_ClaimedFund, masterFunder_ToUpdate.mfMinAda);
    } else {
        throw "MF"
    }
    masterFundersNew = [masterFunderNew].concat(masterFunder_others)
