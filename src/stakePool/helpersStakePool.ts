...
import {
    maxRewards,
    poolDatum_ClaimedFund,
    txID_User_Withdraw_TN,
} from '../types/constantes'
import { StakingPoolDBInterface } from '../types/stakePoolDBModel'
import {
    addAssetsList,
    sumTokensAmt_From_AC_Lucid,
...
export function stakingPoolDBParser(stakingPoolDB: StakingPoolDBInterface) {
    ...
    const stakingPoolDB_: StakingPoolDBInterface = {
        ...
        version:
            stakingPoolDB.version !== undefined ? stakingPoolDB.version : 1,
        ...
        closedAt:
            stakingPoolDB.closedAt !== undefined
                ? new Date(stakingPoolDB.closedAt)
                : undefined,
        swTerminated: stakingPoolDB.swTerminated,
        swZeroFunds: stakingPoolDB.swZeroFunds,
        swPoolReadyForDeleteMasterAndUserScripts:
            stakingPoolDB.swPoolReadyForDeleteMasterAndUserScripts,
        swPoolReadyForDeleteMainScripts:
            stakingPoolDB.swPoolReadyForDeleteMainScripts,
        swPoolReadyForDeletePoolInDB:
            stakingPoolDB.swPoolReadyForDeletePoolInDB,
        ...
        eUTxO_With_ScriptDatum: eUTxODBParser(
            stakingPoolDB.eUTxO_With_ScriptDatum
        ),

        eUTxO_With_Script_TxID_Master_Fund_Datum: eUTxODBParser(
            stakingPoolDB.eUTxO_With_Script_TxID_Master_Fund_Datum
        ),
        eUTxO_With_Script_TxID_Master_FundAndMerge_Datum: eUTxODBParser(
            stakingPoolDB.eUTxO_With_Script_TxID_Master_FundAndMerge_Datum
        ),
        eUTxO_With_Script_TxID_Master_SplitFund_Datum: eUTxODBParser(
            stakingPoolDB.eUTxO_With_Script_TxID_Master_SplitFund_Datum
        ),
        eUTxO_With_Script_TxID_Master_ClosePool_Datum: eUTxODBParser(
            stakingPoolDB.eUTxO_With_Script_TxID_Master_ClosePool_Datum
        ),
        eUTxO_With_Script_TxID_Master_TerminatePool_Datum: eUTxODBParser(
            stakingPoolDB.eUTxO_With_Script_TxID_Master_TerminatePool_Datum
        ),
        eUTxO_With_Script_TxID_Master_Emergency_Datum: eUTxODBParser(
            stakingPoolDB.eUTxO_With_Script_TxID_Master_Emergency_Datum
        ),
        eUTxO_With_Script_TxID_Master_DeleteFund_Datum: eUTxODBParser(
            stakingPoolDB.eUTxO_With_Script_TxID_Master_DeleteFund_Datum
        ),
        eUTxO_With_Script_TxID_Master_SendBackFund_Datum: eUTxODBParser(
            stakingPoolDB.eUTxO_With_Script_TxID_Master_SendBackFund_Datum
        ),
        eUTxO_With_Script_TxID_Master_SendBackDeposit_Datum: eUTxODBParser(
            stakingPoolDB.eUTxO_With_Script_TxID_Master_SendBackDeposit_Datum
        ),
        eUTxO_With_Script_TxID_Master_AddScripts_Datum: eUTxODBParser(
            stakingPoolDB.eUTxO_With_Script_TxID_Master_AddScripts_Datum
        ),
        eUTxO_With_Script_TxID_Master_DeleteScripts_Datum: eUTxODBParser(
            stakingPoolDB.eUTxO_With_Script_TxID_Master_DeleteScripts_Datum
        ),

        eUTxO_With_Script_TxID_User_Deposit_Datum: eUTxODBParser(
            stakingPoolDB.eUTxO_With_Script_TxID_User_Deposit_Datum
        ),
        eUTxO_With_Script_TxID_User_Harvest_Datum: eUTxODBParser(
            stakingPoolDB.eUTxO_With_Script_TxID_User_Harvest_Datum
        ),
        eUTxO_With_Script_TxID_User_Withdraw_Datum: eUTxODBParser(
            stakingPoolDB.eUTxO_With_Script_TxID_User_Withdraw_Datum
        ),
        ...
        txID_Master_FundAndMerge_Script:
            stakingPoolDB.txID_Master_FundAndMerge_Script,

        txID_Master_SplitFund_CS: stakingPoolDB.txID_Master_SplitFund_CS,
        txID_Master_SplitFund_Script:
            stakingPoolDB.txID_Master_SplitFund_Script,

        txID_Master_TerminatePool_CS:
            stakingPoolDB.txID_Master_TerminatePool_CS,
        txID_Master_TerminatePool_Script:
            stakingPoolDB.txID_Master_TerminatePool_Script,

        txID_Master_Emergency_CS: stakingPoolDB.txID_Master_Emergency_CS,
        txID_Master_Emergency_Script:
            stakingPoolDB.txID_Master_Emergency_Script,

        txID_Master_ClosePool_CS: stakingPoolDB.txID_Master_ClosePool_CS,
        txID_Master_ClosePool_Script:
            stakingPoolDB.txID_Master_ClosePool_Script,

        txID_Master_DeleteFund_CS: stakingPoolDB.txID_Master_DeleteFund_CS,
        txID_Master_DeleteFund_Script:
            stakingPoolDB.txID_Master_DeleteFund_Script,

        txID_Master_SendBackFund_CS: stakingPoolDB.txID_Master_SendBackFund_CS,
        txID_Master_SendBackFund_Script:
            stakingPoolDB.txID_Master_SendBackFund_Script,

        txID_Master_SendBackDeposit_CS:
            stakingPoolDB.txID_Master_SendBackDeposit_CS,
        txID_Master_SendBackDeposit_Script:
            stakingPoolDB.txID_Master_SendBackDeposit_Script,

        txID_Master_AddScripts_CS: stakingPoolDB.txID_Master_AddScripts_CS,
        txID_Master_AddScripts_Script:
            stakingPoolDB.txID_Master_AddScripts_Script,

        txID_Master_DeleteScripts_CS:
            stakingPoolDB.txID_Master_DeleteScripts_CS,
        txID_Master_DeleteScripts_Script:
            stakingPoolDB.txID_Master_DeleteScripts_Script,
    ...
    switch (stakingPoolDB_.version) {
        case 2:
            interestRates = stakingPoolDB_.pParams.ppInterestRates.map(
                (item: any) => {
                    return new InterestRateV2(
                        item.iMinDays.plutusDataIndex === 1
                            ? new Maybe<number>()
                            : new Maybe<number>(item.iMinDays.val),
                        item.iStaking,
                        item.iHarvest
                    )
                }
...
export function getCategoryOfInvest(
    poolInfo: StakingPoolDBInterface,
    closedAt: POSIXTime | undefined,
    ...
    function isDiffLessThanMinDays(
        diffForInterestRate: number,
        minDays: number
    ): boolean {
        return diffForInterestRate <= days(minDays)
    }

    function getInterestRateIdxV1(
        interestRates: InterestRateV1[],
        idx: number
    ): number {
        ...
        if (
            x.iMinDays.val === undefined ||
            isDiffLessThanMinDays(Number(diffForInterestRate), x.iMinDays.val)
        ) {
    ...
    function getInterestRateIdxV2(
        interestRates: InterestRateV2[],
        idx: number
    ): number {
        //console.log ("getInterestRate - Init - Rates: " + toJson(interestRates) + " - lenght: " + (interestRates.length))
        if (interestRates.length == 0) {
...
export function getRewardsPerInvest(
    poolInfo: StakingPoolDBInterface,
    closedAt: POSIXTime | undefined,
    interestRates: InterestRates,
    ...
    function getInterestRateV2(interestRates: InterestRateV2[]): {
        iStaking: number
        iHarvest: number
    } {
        // console.log ("getInterestRate - Init - Rates: " + toJson(interestRates) + " - lenght: " + (interestRates.length))
    ...
    function getRewardsV2(
        ...
        if (Number(iStaking) > 0) {
            const rewards = BigInt(
                Math.floor(
                    (iHarvest * Number(duration) * Number(invest)) /
                        (msPerYear * Number(iStaking))
                )
            )
            if (rewards + rewardsNotClaimed > maxRewards) {
                return maxRewards - rewardsNotClaimed
    ...
    if (lastClaim.val === undefined) {
        return getRewards(
            interestRates,
            upperTime - lowerTime(upperTime, depositTime)
        )
    } else {
        return getRewards(
            interestRates,
            upperTime - lowerTime(upperTime, lastClaim.val)
        )
    }
}
...
export function sortFundDatum(
    poolInfo: StakingPoolDBInterface,
    eUTxOs_With_FundDatum: EUTxO[]
) {
...
export function calculate_Sort_FundDatum(
    poolInfo: StakingPoolDBInterface,
    eUTxO_With_FundDatum: EUTxO
) {
    const fundsA =
        getAvailableFunds_In_EUTxO_With_FundDatum(eUTxO_With_FundDatum)
    return fundsA
}

//---------------------------------------------------------------

export function selectFundDatum_WithEnoughValueToClaim(
    eUTxOs_With_FundDatum: EUTxO[],
    claim: BIGINT
) {
    function findNextEUTxO_WithEnoughValueToClaimButMinSize(
        eUTxOs_With_FundDatum: EUTxO[],
        claim: BIGINT
    ) {
        //busco si puedo cubrirlo con uno solo. para ello busco cual es el menor que puede cubrir el claim
        var eUTxO_With_FundDatum_WithEnoughValueToClaimButMinSize:
            | EUTxO
            | undefined = undefined
    ...
    for (var i = 0; i < eUTxOs_With_FundDatum.length; i += 1) {
        var eUTxO = findNextEUTxO_WithEnoughValueToClaimButMinSize(
            eUTxOs_With_FundDatum.slice(i),
            claimLeft
        )
        if (eUTxO) {
...
export function getTotalFundAmountsRemains_ForMasters(
    ...
    for (var i = 0; i < masterFunders.length; i += 1) {
        var [total_, totalMinAda_] = getFundAmountsRemains_ForMaster(
            eUTxO_With_PoolDatum,
            eUTxOs_With_FundDatum,
            masterFunders[i].mfMaster
        )
        total += total_
...
export function getFundAmountsRemains_ForMaster(
    eUTxO_With_PoolDatum: EUTxO,
    eUTxOs_With_FundDatum: EUTxO[],
    master: Master
) {
    ...
    var totalFunding = masterFunders
        .map((mf) => mf.mfFundAmount)
        .reduce((acc, val) => acc + val, 0n)
    var totalRewardsCashedOut = getTotalCashedOut(
        eUTxO_With_PoolDatum,
        eUTxOs_With_FundDatum
    )
    var remaindFunds = totalFunding - totalRewardsCashedOut
    //---------------------
    var totalMinAda = masterFunders
        .map((mf) => mf.mfMinAda)
        .reduce((acc, val) => acc + val, 0n)
    //---------------------
    ...
    if (masterFunder !== undefined) {
        if (masterFunder.mfClaimedFund == poolDatum_ClaimedFund) {
            ...
            var masterParticipation =
                (masterFundAmount * 1000000000n) / totalFunding
            var masterMinAda = masterFunder.mfMinAda
            var masterParticipationAda =
                (masterMinAda * 1000000000n) / totalMinAda
            return [
...
export function getTotalFundAmount(eUTxO_With_PoolDatum: EUTxO) {
    ...
    const total = poolDatum.pdMasterFunders
        .map((mf) => mf.mfFundAmount)
        .reduce((acc, val) => acc + val, 0n)
...
export function getFundAmount_In_EUTxO_With_FundDatum(
    eUTxO_With_FundDatum: EUTxO
) {
...
export function getTotalStakedAmount(eUTxOs_With_UserDatum: EUTxO[]) {
    ...
    for (var i = 0; i < eUTxOs_With_UserDatum.length; i += 1) {
        total += getStakedAmount_In_EUTxO_With_UserDatum(
...
export function getStakedAmount_In_EUTxO_With_UserDatum(
...
export function getAvailableFunds_In_EUTxO_With_FundDatum(
    eUTxO_With_FundDatum: EUTxO
): BIGINT {
...
export function getTotalRewardsToPay_In_EUTxOs_With_UserDatum(
    poolInfo: StakingPoolDBInterface,
    eUTxO_With_PoolDatum: EUTxO,
    eUTxOs_With_UserDatum: EUTxO[]
) {
    var total: BIGINT = 0n
    for (var i = 0; i < eUTxOs_With_UserDatum.length; i += 1) {
        const eUTxO = eUTxOs_With_UserDatum[i]
        total += getRewardsToPay_In_EUTxO_With_UserDatum(
            poolInfo,
            eUTxO_With_PoolDatum,
            eUTxO
        )
...
export function getRewardsToPay_In_EUTxO_With_UserDatum(
    poolInfo: StakingPoolDBInterface,
    eUTxO_With_PoolDatum: EUTxO,
    eUTxO_With_UserDatum: EUTxO
) {
    ...
    const rewards = getRewardsPerInvest(
        poolInfo,
        closedAt,
        poolInfo.pParams.ppInterestRates,
        userDatum.udLastClaimAt,
        claimAt,
        userDatum.udCreatedAt,
        userDatum.udInvest,
        userDatum.udRewardsNotClaimed
    )
...
export function getTotalMastersMinAda_In_EUTxOs_With_UserDatum(
    poolInfo: StakingPoolDBInterface,
    eUTxO_With_PoolDatum: EUTxO
) {
    const poolDatum = eUTxO_With_PoolDatum.datum as PoolDatum
...
export function getTotalUsersMinAda_In_EUTxOs_With_UserDatum(
    poolInfo: StakingPoolDBInterface,
    eUTxOs_With_UserDatum: EUTxO[]
) {
    var total: BIGINT = 0n
...
export function getTotalUserRegistered(
    poolInfo: StakingPoolDBInterface,
    eUTxO_With_PoolDatum: EUTxO,
    eUTxOs_With_FundDatum: EUTxO[],
    eUTxOs_With_UserDatum: EUTxO[]
    ...
    const txID_GetBackInvest_AC_Lucid =
        txID_GetBackInvest_CS + txID_GetBackInvest_TN_Hex

    const txID_GetBackInvest_In_PoolDatum = sumTokensAmt_From_AC_Lucid(
        eUTxO_With_PoolDatum.uTxO.assets,
        txID_GetBackInvest_AC_Lucid
    )

    const assetsList_In_FundDatum = eUTxOs_With_FundDatum
        .map((eUTxO) => eUTxO.uTxO.assets)
        .reduce((acc: Assets[], val) => acc.concat(val), [])
    const assets_In_FundDatum = addAssetsList(assetsList_In_FundDatum)

    const txID_GetBackInvest_In_FundDatum = sumTokensAmt_From_AC_Lucid(
        assets_In_FundDatum,
        txID_GetBackInvest_AC_Lucid
    )
    ...
    const total =
        ...
        Number(txID_GetBackInvest_In_PoolDatum) +
        Number(txID_GetBackInvest_In_FundDatum)
...
export function getTotalCashedOut(
    eUTxO_With_PoolDatum: EUTxO,
    eUTxOs_With_FundDatum: EUTxO[]
) {
    var total: BIGINT = 0n
...
export function getIfUserRegistered(
    pkh: PaymentKeyHash,
    eUTxOs_With_UserDatum: EUTxO[]
) {
    var sw = false
...
export function getUserStaked(
    ...
    eUTxOs_With_UserDatum.forEach((u: EUTxO) => {
        const userDatum: UserDatum = u.datum as UserDatum
        if (userDatum.udUser === pkh) total += userDatum.udInvest as BIGINT
    })
    return total
}
...
export function getUserRewardsPaid(
    pkh: PaymentKeyHash,
    eUTxOs_With_UserDatum: EUTxO[]
) {
    var total: BIGINT = 0n
    eUTxOs_With_UserDatum.forEach((u: EUTxO) => {
        const userDatum: UserDatum = u.datum as UserDatum
        if (userDatum.udUser === pkh) total += userDatum.udCashedOut as BIGINT
    })
    return total
}
...
export function getUserRewardsToPay(
    poolInfo: StakingPoolDBInterface,
    pkh: PaymentKeyHash,
    eUTxO_With_PoolDatum: EUTxO,
    eUTxOs_With_UserDatum: EUTxO[]
